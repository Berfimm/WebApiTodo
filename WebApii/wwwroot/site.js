/*
 * API’yi JQuery üzerinden çağırma
 * Static dosya için wwwroot klasörünün kullanıldığını söylemiştik. Bu uygulama içinde olmadığı için sıfırdan kurmamız gerekir.
 * wwwroot klasörünü aktive etmek için Startup.cs dosyasına Confiure metodu içine aşağıdaki satırlar eklendi.
 *
      *  app.UseDefaultFiles();
      *  app.UseStaticFiles();
      *  
 * wwwroot klasörü içine index.html dosyasını yaratalım ve aşağıdaki dosyaları kopyalayalım.
 * JQuery’den API’ye erişme kodlarımız site.js dosyasına yazacağız. site.js dosyasını da wwwroot klasörü içine yaratın.
 * */




const uri = "api/todoitems";//URL adresi
let todos = null;
